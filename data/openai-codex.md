...
extensions:
  - name: AGENTS.md Instructions
    ...
    vendorTerms: [AGENTS.md, AGENTS.override.md, custom instructions, project_doc_fallback_filenames]
  ...
  - name: Skills
    ...
    vendorTerms: [agent skills, SKILL.md, skill folders, .agents/skills, agents/openai.yaml, "$skill-creator", "$skill-installer"]
  ...
  - name: MCP Servers
    ...
    vendorTerms: [MCP servers, STDIO transport, streamable HTTP transport, OAuth authentication, bearer token authentication, enabled_tools, disabled_tools]
  ...
  - name: Subagents
    ...
    vendorTerms: [subagents, custom agents, parallel delegated workflows, agent threads, spawn_agents_on_csv]
  ...
  - name: Hooks
    ...
    vendorTerms: [hooks, command hooks, hook events, hooks.json]
    scopes: [user-home, project-root]
    interfaces: [CLI, IDE extension]
    availability:
      status: experimental
  ...
  - name: Plugins
    ...
    vendorTerms: [plugins, installable distribution unit, marketplace, plugin directory, "$plugin-creator", plugin manifest]
  ...
  - name: Configuration, Rules, and Requirements
    ...
    vendorTerms: [config.toml, requirements.toml, managed configuration, rules, .rules files, profiles, feature flags, managed_config.toml, cloud-managed requirements, prefix_rule, permissions profiles, granular approval policy, enforce_residency]
